    ...
    return (
        <div style={{ padding: "10px", flex: 1 }}>
            ...
            <div style={{ marginBottom: "10px" }}>
                <button onClick={() => setStartFret(Math.max(startFret - 1, 1))} >-
                </button>
                <span style={{ margin: "0 10px" }}>Start Fret: {startFret}</span>
                <button onClick={() => setStartFret(startFret + 1)}>+
                </button>
            </div>
            ...
            const isSelected = selectedNote && (
                pcToSemitone(getPitchClass(selectedNote)) === tileSem
            );
            ...
            <div style={{ marginTop: "1rem" }}>
                ...
                <p><strong>selected Note: </strong>{selectedNote}</p>
            </div>
        </div>
    );
}